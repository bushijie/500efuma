...
<head>
	...
	if (top.location !== self.location) {   
	    top.location=self.location;   //跳出框架，并回到登录页面
	}   
	</script>   
</head>
<!-- END HEAD -->
...
<body class="login">
	...
	<div class="content">
		...
		<form class="login-form" action="" method="post">
			...
			<div class="alert alert-danger no-account-passwd display-hide">
				<button class="close" data-close="alert"></button>
				<span>请输入账号和密码</span>
			</div>
			<div class="alert alert-danger error-account-passwd display-hide">
				<button class="close" data-close="alert"></button>
				<span>账号或密码错误</span>
			</div>
			...
			<div class="form-actions">
				...
				<input type="checkbox" name="remember" value="0"/>记住密码
				</label>
