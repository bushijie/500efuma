		...
		<table>
			...
			<tbody>
				<?php if(is_array($calendar)): $i = 0; $__LIST__ = $calendar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
						...
						<?php $__FOR_START_7583__=$data['start'];$__FOR_END_7583__=$data['end'];for($i=$__FOR_START_7583__;$i < $__FOR_END_7583__;$i+=1){ if(($i == $d)): ?><td class="today"><a href="#"><?php echo ($i); ?></a></td>
							<?php else: ?>
