...
<html>
	...
	<div id="content-inner">
		<article class="is-post is-post-excerpt">
			...
			<div class="info">
				<span class="date">
					<span class="month"><?php echo ($info["ctm_M"]); ?><span><?php echo ($info["ctm_F"]); ?></span></span> 
					<span class="day"><?php echo ($info["ctm_D"]); ?></span>
					<span class="year">, <?php echo ($info["ctm_Y"]); ?></span>
				</span>
				<ul class="stats">
		...
		<table>
			...
			<tbody>
				<?php if(is_array($calendar)): $i = 0; $__LIST__ = $calendar;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
						...
						<?php $__FOR_START_22625__=$data['start'];$__FOR_END_22625__=$data['end'];for($i=$__FOR_START_22625__;$i < $__FOR_END_22625__;$i+=1){ if(($i == $d)): ?><td class="today"><a href="#"><?php echo ($i); ?></a></td>
							<?php else: ?>
