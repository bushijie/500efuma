...
INSERT INTO `fm_article_comment` VALUES (1,24,0,'',0,'','&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n<br />\r\n&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;','2014-12-31 09:59:00','2014-12-31 01:59:00'),(2,24,1,'',0,'','&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n<br />\r\n&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;','2014-12-31 09:59:16','2014-12-31 01:59:16'),(3,24,0,'',0,'','&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n<br />\r\n&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;','2014-12-31 09:59:20','2014-12-31 01:59:20'),(4,24,0,'',0,'','&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n<br />\r\n&lt;input&nbsptype=&quot;text&quot;&gt;&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;<br />\r\n&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&lt;input&nbsptype=&quot;text&quot;&gt;','2014-12-31 10:16:06','2014-12-31 02:16:06');
...
INSERT INTO `fm_article_type` VALUES (1,'JAVA','java',1,1,'2014-12-10 10:35:35',NULL),(2,'PHP','php',1,1,'2014-12-10 10:35:53',NULL),(3,'Python','python',1,1,'2014-12-10 10:35:53',NULL),(4,'动漫资讯','acg',1,1,'2014-12-10 10:36:41',NULL),(5,'随笔','essay',1,1,'2014-12-10 10:36:41',NULL),(6,'NodeJS','nodejs',1,1,'2014-12-10 10:36:58',NULL),(7,'Linux','linux',1,1,'2014-12-10 10:37:15',NULL),(8,'C++','cjj',1,0,'2014-12-24 14:37:47',NULL),(9,'Git','git',1,1,'2014-12-10 10:39:07',NULL),(10,'开发杂项','other',1,1,'2014-12-10 10:39:07',NULL),(78,'HTML5','html5',1,1,'2014-12-18 10:47:47',NULL);
/*!40000 ALTER TABLE `fm_article_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `fm_email_task`
--

DROP TABLE IF EXISTS `fm_email_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_email_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '发送类型  1-游客评论   2-站长评论',
  `email` varchar(500) NOT NULL COMMENT '发送对象',
  `title` longtext NOT NULL COMMENT '标题',
  `content` longtext NOT NULL COMMENT '内容',
  `admin_id` int(11) DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '发送状态  1-发送成功   0-发送失败',
  `ctm` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='邮件任务列表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fm_email_task`
--

LOCK TABLES `fm_email_task` WRITE;
/*!40000 ALTER TABLE `fm_email_task` DISABLE KEYS */;
/*!40000 ALTER TABLE `fm_email_task` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `fm_system` (
  ...
  `admin_id` int(11) NOT NULL,
  `ctm` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `utm` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-12-31 19:01:39
