...
var skel = function() {
    var a = {
        ...
        attachElements: function(d) {
            ...
            f,
            e;
            for (f in d) b[d[f].priority] || (b[d[f].priority] = []),
            b[d[f].priority].push(d[f]);
            for (f in b) if (0 != b[f].length) for (e in b[f]) if (d = a.locations[b[f][e].location]) {
        ...
        updateState: function() {
            ...
            for (b in e) if (d = a.breakpoints[e[b]], 0 != d.elements.length) for (c in d.elements) a.cache.states[a.stateId].elements.push(d.elements[c]),
            f.push(d.elements[c]);
        ...
        changeState: function(d) {
            ...
            if (a.cache.states[a.stateId]) e = a.cache.states[a.stateId];
                ...
                for (b in d) {
                    ...
                    if (0 < a.breakpoints[d[b]].elements.length) for (c in a.breakpoints[d[b]].elements) e.elements.push(a.breakpoints[d[b]].elements[c])
                }
            }
            a.detachAllElements();
            ...
            a.DOMReady(function() {
                var a, b;
                if ((a = document.getElementsByClassName("skel-cell-mainContent")) && 0 < a.length) if (a = a[0], e.config.grid.collapse) b = document.createElement("div"),
                b.innerHTML = "",
        ...
        newStyleSheet: function(a) {
            ...
            b.type = "text/css";
            // 本地调试路径
//            b.href = "http://localhost/500efuma/Template/" + a;
            // SAE项目部署路径
             b.href = "/Template/" + a;
            return b
        },
        ...
        initConfig: function() {
            ...
            b.elements = [],
            a.breakpoints[k] = b,
            a.config.preloadStyleSheets && b.config.hasStyleSheet && f.push(a.newStyleSheet(a.config.prefix + "-" + k + ".css"));
        ...
        init: function() {
            a.isLegacyIE = navigator.userAgent.match(/MSIE ([0-9]+)\./) && 8 >= RegExp.$1 ? !0 : !1; (function() {
                ...
                c = function(a) {
                    ...
                    a = !1;
                    if (!e) if (e = !0, "loading" !== d.readyState && l(), d.addEventListener) d.addEventListener("DOMContentLoaded", h, !1),
                    b.addEventListener("load", h, !1);
            ...
            function(a, c) {
                ...
                for (0 > e && (e += d); e < d; e++) if (a instanceof Array && e in a && a[e] === c) return e;
                return - 1
            };
            a.initConfig();
